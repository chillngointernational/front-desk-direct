                ...
                <div style={{ background: '#fff', border: '1px solid #e0dcd6', borderRadius: 6, overflow: 'hidden' }}>
                    <div style={{ display: 'flex', flexWrap: 'wrap' }}>
                        ...
                        <div style={{ ...cellStyle(false), flex: '0 0 auto', width: 100 }} className="!w-1/3 sm:!w-[100px]">
                            ...
                            <select value={kids} onChange={e => setKids(e.target.value)} style={selectStyle}>{[0, 1, 2, 3, 4, 5, 6].map(n => <option key={n} value={n}>{n}</option>)}</select>
                        </div>
...
export default function Fontainebleau() {
    ...
    return (
        <div style={{ background: '#fff', color: '#333', fontFamily: "'Libre Franklin',-apple-system,sans-serif", fontSize: 14, lineHeight: 1.6 }} className="min-h-screen">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6" style={{ marginBottom: 32 }}>
                        ...
                        <div style={{ background: '#fff', borderRadius: 8, overflow: 'hidden', border: '1px solid #eae6e0' }}>
                            ...
                            <div style={{ padding: 24 }}>
                                ...
                                <p style={{ fontSize: 13, color: '#666', lineHeight: 1.8, margin: 0 }}>The iconic Bow Tie pool with daybeds and cabanas. Oasis pool with island cabana. Family Pool with waterslide. Arkadia day club (Fri–Sun). 1,000 feet of private beach with paddleboards, kayaks, and windsurfing. Private cabanas with butler service, flat-screen TV, and WiFi.</p>
                            </div>
                        </div>
                        <div style={{ background: '#fff', borderRadius: 8, overflow: 'hidden', border: '1px solid #eae6e0' }}>
                            ...
                            <div style={{ padding: 24 }}>
                                ...
                                <p style={{ fontSize: 13, color: '#666', lineHeight: 1.8, margin: 0 }}>40,000 sq ft Lapis Spa with 32 treatment rooms, rain tunnels, saunas, and hydrotherapy. Fitness center with ocean views, heavy bags, and yoga classes. LIV Nightclub — one of the world's most famous venues — plus Bleaulive entertainment events.</p>
                            </div>
                        </div>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div style={{ background: '#fff', border: '1px solid #eae6e0', borderRadius: 8, padding: 24 }}>
                            ...
                            <div className="grid grid-cols-2 gap-x-6" style={{ fontSize: 12, color: '#666' }}>
                                {[['Address', '4441 Collins Ave, Miami Beach, FL 33140'], ['Built', '1954 (Morris Lapidus)'], ['Renovated', '$1B renovation (2008)'], ['Towers', 'Chateau, Versailles, Trésor, Sorrento'], ['Rooms', '1,504 rooms & suites'], ['Property', '22 oceanfront acres'], ['Beach', '1,000 ft private beach'], ['Pools', '11 pools + cabanas'], ['Restaurants', '9+ dining venues'], ['Spa', 'Lapis — 40,000 sq ft'], ['Nightclub', 'LIV (dress code)'], ['Check-in / Out', '4:00 PM / 11:00 AM'], ['Resort Fee', '$53/night + tax'], ['Parking', 'Valet $55–70/night'], ['Pets', 'Allowed (fees apply)'], ['Airport', 'MIA — 20 min']].map(([l, v]) => (
                        ...
                        <div style={{ background: '#fff', border: '1px solid #eae6e0', borderRadius: 8, padding: 24 }}>
                            ...
                            <div className="grid grid-cols-2 gap-x-6 gap-y-2" style={{ fontSize: 13, color: '#666' }}>
                                {['Room Service', '24hr Front Desk', 'Concierge', 'Fitness Center', 'Beach Access', 'Water Sports', 'Kids Activities', 'Playground & Waterslide', 'Hot Tub / Jacuzzi', 'Steam Room & Sauna', 'Yoga Classes', 'Free WiFi', 'In-Room Safe', 'Valet Parking', 'Car Rental Desk', 'Business Center', 'Gift Shop', 'ATM on Site', 'Wheelchair Access', 'Laundry Service', 'Pet Friendly', 'Currency Exchange', 'Babysitting', 'Game Room'].map((a, i) => (
                                    <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '3px 0' }}><ChkIco /> <span>{a}</span></div>
                                ))}
                            </div>
                        </div>
                    </div>
            ...
            {/* 3. FAQ (collapsible) */}
            <section id="faq" style={{ borderTop: '1px solid #eae6e0', background: '#fff' }}>
                <div style={{ width: '100%', maxWidth: 820, marginLeft: 'auto', marginRight: 'auto', paddingLeft: 24, paddingRight: 24, paddingTop: 28, paddingBottom: 28 }}>
                    <details>
                        <summary style={{ fontSize: 18, fontWeight: 600, color: '#1a1a1a', cursor: 'pointer', listStyle: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12 }}>
